...
The original text contains a condition of the F bit that does not correspond to the later description. This inconsistency would lead to incorrect interpretation and handling of the NT field.
