...
The example in Annex A.2 uses an inconsistent tx-frequency value. This inconsistency affects the understanding and implementation of the example configuration.
