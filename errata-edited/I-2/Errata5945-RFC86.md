...
The original description of IPv6 packet fragmentation incorrectly divides the original packet into three parts and incorrectly describes the composition of the resulting fragment packets. It also defined Fragment Offset as pointing to an incorrect part of the original packet.
